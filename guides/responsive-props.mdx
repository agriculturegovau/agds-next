...
Instead of manually writing CSS media queries throughout your codebase, our primitive components (`Box`/`Flex`/`Stack`) allow you to provide arrays and objects to generate responsive styles in your project.
