...
Our component library is built with React, a popular javascript library for building User Interfaces. If you’re new to React we recommend going through official [React getting started documentation](https://facebook.github.io/react/docs/hello-world.html) and follow along using the [React Hello World CodePen example](http://codepen.io/gaearon/pen/ZpvBNJ?editors=0010).
