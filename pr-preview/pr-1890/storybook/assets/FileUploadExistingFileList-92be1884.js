import{j as a}from"./responsive-123a9343.js";import{S as s}from"./Stack-938d29d6.js";import{F as l}from"./FileUploadExistingFile-e43e4189.js";const o=({files:i,hideThumbnails:t,onRemove:e})=>i.length?a(s,{"aria-label":"Existing files",as:"ul",gap:.5,children:i.map((n,r)=>a(l,{file:n,hideThumbnails:t,onRemove:()=>e==null?void 0:e(n)},r))}):null;o.__docgenInfo={description:"",methods:[],displayName:"FileUploadExistingFileList",props:{files:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
	/** The file name. */
	name: string;
