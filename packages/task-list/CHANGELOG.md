...
- 9ff8a7fed: Added new status option `blocked`
- 127cbaa29: - Added title and step count above TaskList
  - Added `doneRecently` status
  - UI refresh

### Patch Changes

- 9ff8a7fed: Update status labels with new language
...
- 811e848a9: Fixed typo
- 8d83083ea: Fixed invalid HTML
