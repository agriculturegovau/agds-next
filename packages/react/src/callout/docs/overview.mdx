...
Use callout to draw a users attaention to important snippets of static information.
...
- use to format content not included in the main text such as support and contact details, checklists, definitions and
