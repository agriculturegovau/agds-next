...
<ColourComponentSection shadeAlt>
	{`<Stack
	as="ul"
	background="body"
	css={{ listStyle: 'none' }}
...
>
	<Box as="li">
		<Callout title="Callout: on body background">
			<Text as="p">Description of the callout.</Text>
		</Callout>
	</Box>
	<Box as="li">
		<Callout title="Callout: info tone on body background" tone="info">
			<Text as="p">Description of the callout.</Text>
		</Callout>
	</Box>
</Stack>
<Stack as="ul" background="bodyAlt" css={{ listStyle: 'none' }} padding={1.5}>
	<Box as="li">
		<Callout title="Callout: on bodyAlt background">
			<Text as="p">Description of the callout.</Text>
		</Callout>
	</Box>
</Stack>
