...
Compact version of the callout can be used when there is limited space, such as inside of an Accordion to let the user know that, based on their response, they may need to provide additional information.
