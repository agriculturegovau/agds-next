...
The interactions for an icon-only version differ to meet WCAG 1.4.1. On hover, the icon size and stroke width increases slightly to indicate that the button is interactive.
