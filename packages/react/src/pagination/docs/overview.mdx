...
You can pass a generated string that suits your use-case, or use the `generatePaginationRangeText` function to generate a basic string for you. `generatePaginationRangeText` returns a string which follows the format of `1 - 10 of 458 items`.
