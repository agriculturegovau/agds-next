...
figmaGalleryNodeId: 12023%3A97305
---
...
- include a maximum of 7 for smaller screens and 14 for larger screens
- use links over buttons where possible
- ensure the user knows which page they are on
- include Previous and Next chevrons
- always place below the content you are paginating
- centre align.

<DontHeading />

- left or right align
- display more than 5 list items in the main area.
