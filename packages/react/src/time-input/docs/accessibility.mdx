Learn more about how to meet WCAG success criteria when implementing time inputs. This makes them accessible and inclusive for users of all abilities and situations.

The time input component passed accessibility testing in 2024.

## Clear labels and instructions

### Requirements

- Labels clearly identify the purpose of the time input.
- The purpose of the time input is understood and conveyed by assistive technology.
- Hint text is provided when it’s helpful – for example, when more than one time format is acceptable or when the time they enter will be reformatted to display your format requirements.
...
- Hint text is provided when it’s helpful – for example, invalid time formats and out-of-range times.
...
- Provides safeguards against critical errors with significant consequence
...
- Clear label identifying the time input field.
