Learn more about how to meet WCAG success criteria when implementing autocomplete. This makes them accessible and inclusive for users of all abilities and situations.

The autocomplete component passed accessibility testing in 2024.

## Clear labels and instructions

### Requirements

- Labels clearly identify the purpose of the autocomplete.
- The purpose of the autocomplete is understood and conveyed by assistive technologies.
- Hint text is provided when its helpful – for example, let users know they can type to see results.
...
- Clear label identifying the autocomplete.
...
- [AgDS accessibility guidance – Error management](/foundations/accessibility/error-management)
- [AgDS accessibility guidance – Clear communication – Labels](/foundations/accessibility/clear-communication#labels)
