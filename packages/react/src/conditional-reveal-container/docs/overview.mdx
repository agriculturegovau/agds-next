...
() => {
	...
	return (
		<FormStack>
			...
			<ConditionalRevealContainer visible={isChecked('email')}>
				<TextInput type="email" label="Email address" required />
			</ConditionalRevealContainer>
			<ConditionalRevealContainer visible={isChecked('phone')}>
				<TextInput label="Phone number" inputMode="numeric" required />
			</ConditionalRevealContainer>
			<ConditionalRevealContainer visible={isChecked('textMessage')}>
...
() => {
	...
	return (
		<FormStack>
			...
			<ConditionalRevealContainer visible={Boolean(value.length)}>
				{isChecked('email') && (
...
() => {
	...
	return (
		<FormStack>
			...
			<ConditionalRevealContainer visible={isChecked('post')}>
				<H3>Address</H3>
				<TextInput
					inputMode="text"
