---
title: Control group
description: Control groups allow related checkboxes and radios to be grouped together to allow users to select one or more options from a list.
group: Forms
storybookPath: /story/forms-controlgroup--checkbox-group
figmaGalleryNodeId: 12926%3A104981
relatedComponents: ['checkbox', 'radio', 'switch']
---
...
Multiple [Checkboxes](components/checkbox) can be placed inside a Control group to allow users to select one or more item from a list of options.
