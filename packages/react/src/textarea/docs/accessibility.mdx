...
Learn more about how to meet WCAG success criteria when implementing text areas. This makes them accessible and inclusive for users of all abilities and situations. 
...
Labels clearly identify the purpose of the text area. 
...
Provide hint text when it’s helpful – for example, to communicate maximum character length for the text area. 
...
Clear label identifying the text area. 
