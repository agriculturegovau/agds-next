...
Sub-level items can be revealed when the parent item is active. This option is best when the number of visible items in list will increase cognitive load or cause excessive scrolling or tab stops for keyboard users. 
