...
The app layout sidebar should be hidden by default while users are completing multi-page and single page forms to reduce distractions and support user focus (as seen in the following example).
