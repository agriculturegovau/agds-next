...
If the same input can create multiple conditional revealed fields or content (such as a checkbox input), you can use one conditional reveal component and apply conditional rendering in the children.

Don't use multiple conditional reveal components. Using multiple conditional rendering will create multiple dividers.
