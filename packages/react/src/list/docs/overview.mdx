...
- use with block section components like [Page alert](/components/page-alert) and [Modal](/components/modal), which enforce 1rem spacing between elements.
...
- use for long form content - instead use a plain `ol` or `ul` HTML element inside of the [Prose](/components/prose) component.
