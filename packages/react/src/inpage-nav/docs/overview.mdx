...
The Inpage nav should be used in combination with 'Back to top' links using [Direction links](/components/direction-link) in section paragraphs to help users return to the menu on long pages.
