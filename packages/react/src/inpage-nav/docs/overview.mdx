...
The inpage nav (or page contents) is placed at the top of a page and consists of anchor links that guide users to page sections. The inpage nav should be used in combination with 'Back to top' links in section paragraphs to help users return to the menu on long pages.
