---
title: Fieldset
description: The Fieldset component is used to group related form fields. Grouping form fields in a meaningful way can make forms much easier to handle for everyone.
group: Forms
