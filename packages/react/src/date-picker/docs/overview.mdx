...
When using the `DatePicker` component in scenarios where vertical space is not a concern (e.g. in a form for capturing user data), you can use the `hideDateFormatLabel` prop to hide the date format from the label.
...
When using the `DateRangePicker` component in scenarios where vertical space is not a concern (e.g. in a form for capturing user data), you can use the `hideDateFormatLabel` prop to hide the date format from the label.
