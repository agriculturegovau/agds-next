...
When using the `DatePicker` component in a form for capturing user data, you can use the `hideDateFormatLabel` prop to hide the date format and automatically append `"(optional)"` like other form components in AgDS.
