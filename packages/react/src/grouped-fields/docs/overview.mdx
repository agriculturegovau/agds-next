...
- always provide a meaningful legend, regardless if it’s visually hidden
...
- group unrelated inputs as a space saving exercise.
...
The `message` should be generic so it can apply and make sense to both inputs.
