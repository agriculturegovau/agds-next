...
Use the `accept` prop to guide the user toward the accepted file types. This will automatically add a hint to guide users, although you can override this by providing your own `hint`.
