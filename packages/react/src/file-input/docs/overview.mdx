...
- inidicate size and type requirements in the hint
...
Use the `accept` prop to restrict the accepted file types. This will automatically add a hint to guide users, although you can override this by providing your own `hint`.

_NOTE: for security reasons you must validate the file type in your backend and not rely on frontend validation._
...
<FileInput
	...
	hint="Only upload image files of type .jpg, .jpeg, .png"
	label="Upload image"
/>
```
