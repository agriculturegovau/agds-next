...
- Use the [appropriate `type` attribute](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/input#input_types) for the type of data that the user will enter – for example: `tel`, `email`, `url`.
