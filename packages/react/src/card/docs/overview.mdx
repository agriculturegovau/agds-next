...
figmaGalleryNodeId: 11978%3A102122
---
...
- only have one link per card
- avoid images for the most part unless they add information and are relevant
- use a pictogram only if it provides meaningful context
...
- use formatted or rich text such as lists, links etc. in the content area
