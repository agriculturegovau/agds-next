...
```jsx live
<Stack gap={2}>
	<Card shadow clickable footer={<CardFooter>Metadata</CardFooter>}>
		<CardInner>
			<Stack gap={1}>
				<Heading type="h3">
					<CardLink href="#">Title of article</CardLink>
	...
	>
		<CardInner>
			<Stack gap={1}>
				<Heading type="h3">
					<CardLink href="#">footerOutside Title of article</CardLink>
				</Heading>
				<Text as="p">Some text</Text>
			</Stack>
		</CardInner>
	...
	<Card shadow clickable footerOutside>
		<CardInner>
			<Stack gap={1}>
				<Heading type="h3">
					<CardLink href="#">LEGACY footerOutside Title of article</CardLink>
				</Heading>
				<Text as="p">Some text</Text>
			</Stack>
		</CardInner>
	...
	<Card shadow clickable>
		...
		<CardFooter>Metadata</CardFooter>
	</Card>
	<Card shadow clickable footerOutside>
		<PlaceholderImage />
		<CardInner>
...
```jsx live
<Stack gap={2}>
	<Card footer={<CardFooter>Metadata</CardFooter>}>
		<CardInner>
			<Stack gap={1}>
				<Heading type="h3">
					<CardLink href="#">Title of article</CardLink>
