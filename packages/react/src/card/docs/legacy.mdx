<Callout tone="info">
	This is the legacy (versions v1.26.0 and below) documentation for Cards and will be removed in the next major version.
...
<Callout tone="info">
	...
	or `CardHeader` is used. We recommend migrating to the `footer`, `content` and
	`header` props for all instances.
</Callout>
	...
	<Card as="li" footerOutside clickable shadow>
		...
		<CardInner>
			<Stack gap={1}>
				...
				<Text as="p">Degraded UX and accessibility</Text>
			</Stack>
		</CardInner>
		<CardFooter>
