...
- use the muted overlay when it is beneficial to retain the context of the underlying page content, especially for sighted users with cognitive disabilities
