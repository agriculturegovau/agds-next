...
- only use side drawers for filters, small overflow form actions and related guidance content if you can’t provide these interactions on the parent page
- only use side drawers for external facing forms when you need to maintain the user’s context of the parent page
