...
const boxPaletteVars = {
	...
	foregroundInverse: '--agds-foreground-inverse',
...
export const boxPalettes = {
	light: css({
		...
		[boxPaletteVars.foregroundInverse]: `var(${themeVars.lightForegroundInverse})`,
	...
	dark: css({
		...
		[boxPaletteVars.foregroundInverse]: `var(${themeVars.darkForegroundInverse})`,
...
export const boxPalette = {
	...
	foregroundInverse: `var(${boxPaletteVars.foregroundInverse})`,
