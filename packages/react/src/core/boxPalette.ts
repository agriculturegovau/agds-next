...
const boxPaletteVars = {
	...
	foregroundSelected: '--agds-foreground-selected',
...
export const boxPalettes = {
	light: css({
		...
		[boxPaletteVars.foregroundSelected]: `var(${themeVars.lightForegroundSelected})`,
	...
	dark: css({
		...
		[boxPaletteVars.foregroundSelected]: `var(${themeVars.darkForegroundSelected})`,
...
export const boxPalette = {
	...
	foregroundSelected: `var(${boxPaletteVars.foregroundSelected})`,
