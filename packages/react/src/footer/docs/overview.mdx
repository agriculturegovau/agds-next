...
title: Footer
group: Layout
description: Footers live at the bottom of a page and help users find supplementary information relevant to their needs.
storybookPath: /story/layout-footer--body-background
figmaGalleryNodeId: 11978%3A103355
---
...
<ColourComponentSection shadeAlt>
	...
	<Stack gap={1.5} padding={1.5}>
		<H4>Footer: on [[PALETTE]] body background</H4>
		<Footer>
			<nav aria-label="footer">
				<LinkList
					links={[
	...
	<Stack background="bodyAlt" gap={1.5} padding={1.5}>
		<H4>Footer: on [[PALETTE]] bodyAlt background</H4>
		<Footer background="bodyAlt">
			<nav aria-label="footer">
				<LinkList
					links={[
