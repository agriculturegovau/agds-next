...
Dropdown menu actions can have important consequences. Learn about using status messages to communicate important changes in content, especially destructive ones. Visit [AgDS Accessibility – States and status – requirements](#TODO).
