...
Use the `DropdownMenuGroup` and `DropdownMenuItemRadio` components to create a list of options where only 1 item can be selected at a time, similar to a list of [Radios](/component/radios).
