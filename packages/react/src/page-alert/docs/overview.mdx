...
You can use the `PageAlertTitle` component directly in the title prop, to change the element used for the title.
...
<PageAlert tone="info" title="New update" onDismiss={console.log}>
	<Text as="p">
		A new feature has been added to the service. <a href="#">Learn more</a>.
	</Text>
</PageAlert>
```
