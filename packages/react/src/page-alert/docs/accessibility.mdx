...
Avoid long messages and ensure alerts stay visible long enough for people with disabilities to read. [See WCAG 2.1 success criterion 2.2.3 (AAA)](https://www.w3.org/WAI/WCAG21/Understanding/no-timing.html) for more detail.

See [WCAG 2.1 success criterion 2.2.4 (AAA)](https://www.w3.org/WAI/WCAG21/Understanding/interruptions.html) for guidance on optional functionality that enables people with visual and cognitive disabilities to control which alerts they see.
