...
Image files should be displayed with thumbnails which are 72px by 72px. Passing full-size images will to `thumbnailSrc` prop will result with long load times.
