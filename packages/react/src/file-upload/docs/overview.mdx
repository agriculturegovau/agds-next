...
- upload selected files instantly as they are selected or on submissionLoadingBlankete
...
For a complete list allowed file formats, please refer to [the source code](https://github.com/steelthreads/agds-next/blob/main/packages/react/src/file-upload/utils.ts).
