...
Be aware of clickable regions of elements in table rows and tables (such as buttons and links) and ensure they have adequate sizing within a clickable table row to prevent users from accidentally trigger the table row click event.
