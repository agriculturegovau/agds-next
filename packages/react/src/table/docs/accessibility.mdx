...
The callback function should only be used in scenarios where the paradigm is clearly understood and has many existing examples (e.g. email applications often allow users to click the entire row to open an email).
