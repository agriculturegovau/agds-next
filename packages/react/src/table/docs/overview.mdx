	...
	<Table>
		...
		<TableBody>
			<TableRow>
				...
				<TableCell textAlign="right">20/06/2022</TableCell>
			...
			<TableRow>
				...
				<TableCell textAlign="right">25/06/2022</TableCell>
				<TableCell textAlign="right">
					<StatusBadge weight="subtle" tone="info" label="In progress" />
				</TableCell>
				<TableCell textAlign="right">
			...
			<TableRow>
				...
				<TableCell textAlign="right">02/07/2022</TableCell>
				<TableCell textAlign="right">
			...
			<TableRow>
				...
				<TableCell textAlign="right">05/08/2022</TableCell>
				<TableCell textAlign="right">
					<StatusBadge weight="subtle" tone="info" label="In progress" />
				</TableCell>
				<TableCell textAlign="right">
			...
			<TableRow>
				...
				<TableCell textAlign="right">19/10/2022</TableCell>
				<TableCell textAlign="right">
					<StatusBadge weight="subtle" tone="success" label="Completed" />
				</TableCell>
				<TableCell textAlign="right">
