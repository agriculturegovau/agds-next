...
<TableWrapper>
	<Table>
		<TableCaption>Items sold December 2023</TableCaption>
		<TableHead>
			<TableRow>
				...
				<TableHeader scope="col">Rings</TableHeader>
			</TableRow>
		</TableHead>
		<TableBody>
			<TableRow>
				...
				<TableCell as="td">80</TableCell>
				<TableCell as="td">12</TableCell>
				<TableCell as="td">43</TableCell>
				<TableCell as="td">36</TableCell>
				<TableCell as="td">19</TableCell>
			</TableRow>
			<TableRow>
				<TableCell as="th" fontWeight="bold" scope="row">
					Sydney
				</TableCell>
				<TableCell as="td">89</TableCell>
				<TableCell as="td">34</TableCell>
				<TableCell as="td">69</TableCell>
				<TableCell as="td">85</TableCell>
				<TableCell as="td">38</TableCell>
			</TableRow>
			<TableRow>
				...
				<TableCell as="td">56</TableCell>
				<TableCell as="td">22</TableCell>
				<TableCell as="td">43</TableCell>
				<TableCell as="td">72</TableCell>
				<TableCell as="td">23</TableCell>
			</TableRow>
			<TableRow>
				<TableCell as="th" fontWeight="bold" scope="row">
					Brussels
				...
				<TableCell as="td">27</TableCell>
				<TableCell as="td">38</TableCell>
				<TableCell as="td">69</TableCell>
				<TableCell as="td">28</TableCell>
			</TableRow>
			<TableRow>
				<TableCell as="th" fontWeight="bold" scope="row">
					Gent
				</TableCell>
				<TableCell as="td">46</TableCell>
				<TableCell as="td">18</TableCell>
				<TableCell as="td">50</TableCell>
				<TableCell as="td">61</TableCell>
				<TableCell as="td">15</TableCell>
			</TableRow>
		</TableBody>
	</Table>
</TableWrapper>
