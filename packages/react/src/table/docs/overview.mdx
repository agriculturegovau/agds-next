...
If you need to use Buttons instead of TextLinks, you can use the `variant='text'` prop to remove the background and border. You can also choose to use icons if they are meaningful to the user.
	...
	<Table>
		...
		<TableBody>
			<tr>
				...
				<TableCell>
					<Button variant='text' iconBefore={EditIcon}>Edit</Button>
				</TableCell>
			</tr>
			<tr>
				<TableCell as="th" scope="row" fontWeight="bold">
