							...
							>
								<TableWrapper>
									<Table>
										<TableHead>
											<TableRow>
												<TableHeader scope="col">Age range</TableHeader>
												<TableHeader scope="col">Employment rate</TableHeader>
												<TableHeader scope="col">Average income</TableHeader>
											</TableRow>
										</TableHead>
										<TableBody>
											{item.subItems.map((subItem, index) => (
												<>
													<TableRow key={subItem.key}>
														<TableCell>{subItem.age}</TableCell>
														<TableCell>{subItem.employment}</TableCell>
														<TableCell>{subItem.income}</TableCell>
													</TableRow>
												</>
											))}
										</TableBody>
