...
It is important to add `VisuallyHidden` content to the table’s caption to inform blind screen reader users of the purpose of `TableHeaderSortable` buttons.
