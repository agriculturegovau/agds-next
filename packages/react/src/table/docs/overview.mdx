...
You can see a working example of this component in the [Table Filtering Patterns](/storybook/index.html?path=/story/patterns-data-filtering-and-sorting--medium).
