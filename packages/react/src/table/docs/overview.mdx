...
The `<TableRow>` component accepts an optional, `onClick` callback function that will run when the table row or cell is clicked. Refer to the [Table accessibility document](/components/table/accessibility#tablerow-and-onclick) for further information.
