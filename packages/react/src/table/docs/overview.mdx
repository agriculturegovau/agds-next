...
Clickable rows should only be used as an enhancement for mouse/touch users to be able to quickly activate the “main” action on the table.

They should only be used in scenarios where the concept is clearly understood with common prior art (e.g. email applications often allow users to click the entire row to open an email).
...
<>
	<Stack gap={1.5} paddingX={{ xs: 0.75, md: 1.5 }} paddingY={1.5}>
		<TableWrapper>
			<Table striped>
				<TableCaption>Table: on [%_PALETTE_%] body background</TableCaption>
				<TableHead>
					<TableRow>
						<TableHeader scope="col">Location</TableHeader>
						<TableHeader scope="col" textAlign="right">
	...
	>
		<TableWrapper>
			<Table striped>
				<TableCaption>Table: on [%_PALETTE_%] bodyAlt background</TableCaption>
				<TableHead>
					<TableRow>
						<TableHeader scope="col">Location</TableHeader>
						<TableHeader scope="col" textAlign="right">
