...
- only use dropdown menu for actions if there are three or more essential actions
...
- use a conmbination of actions in table cells and actions in dropdown menus together in the same table row
...
Dropdown menus can be used to contain three or more essential actions in tables. Labels should be incluided on dropdown menu buttons.

If each table row can open a page or drawer to view more information, the cells in the first column should be displayed as bold clickable links under the table header labeled with the unique identifier.
