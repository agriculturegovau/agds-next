...
The `<TableRow>` component accepts an optional, `onClick` callback function that will run when the table row or cell is clicked. Refer to the [accessibility guidance for clickable rows](/components/table/accessibility#tablerow-and-onclick).
