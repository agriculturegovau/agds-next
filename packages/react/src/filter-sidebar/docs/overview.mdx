...
<FilterSidebar numberOfActiveFilters={3}>
	<TextInput label="Example filtering input 1" value="Example" block />
	<TextInput label="Example filtering input 2" value="Example" block />
	<TextInput label="Example filtering input 3" value="Example" block />
</FilterSidebar>
```
