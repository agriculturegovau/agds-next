...
Items in an [Accordion group](/components/accordion#accordion-group) don’t influence each other, otherwise it’s unpredictable for the user. For example, opening one item in a group will not close another.
