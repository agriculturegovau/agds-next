...
<Accordion>
	<AccordionItem title="Edge-to-edge image">
		<img alt="Placeholder" src="/img/placeholder/600X260.png" width="100%" />
		<AccordionItemContent>
			<Text as="p">
...
<ColourComponentSection shadeAlt>
	...
	<Box padding={1.5}>
		<Accordion>
			<AccordionItem title="Accordion: on body background" background="body">
				<AccordionItemContent>
					<Stack gap={1}>
						<Text as="p">Here is the accordion content.</Text>
	...
	<Box background="bodyAlt" padding={1.5}>
		<Accordion>
			<AccordionItem
				title="Accordion: on bodyAlt background"
				background="bodyAlt"
			>
				<AccordionItemContent>
					<Stack gap={1}>
