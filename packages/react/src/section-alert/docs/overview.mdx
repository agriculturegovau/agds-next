...
relatedComponents: ['global-alert', 'page-alert', 'status-badge']
...
```jsx live
<Stack gap={1}>
	<SectionAlert title="To Do" tone="notStartedLow" />
	<SectionAlert title="Doing" tone="inProgressLow" />
	<SectionAlert title="Paused" tone="pausedLow" />
	<SectionAlert title="Help" tone="unknownLow" />
