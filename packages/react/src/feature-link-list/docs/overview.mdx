...
description: Feature link list is a vertical list of important links. It adds prominence and additional information to help users find and understand important navigation items.
group: Navigation
...
Links can also be used without a description should additional information provides little value or negatively increase cognitive load.
