...
- use to to provide an emphasis and hierarchy to link lists
- avoid opening links in new tabs, but provide an external link icon when it is not possible to open the link in the same browser tab
...
Links can also be used without a description, should the label alone provide enough information.
...
Lists of cards and links should should have headings.
