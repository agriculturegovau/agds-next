Learn more about how to meet WCAG success criteria when implementing date pickers. This makes them accessible and inclusive for users of all abilities and situations.

The date picker component passed accessibility testing in 2022 and 2024.
...
- The purpose of the date picker is understood and conveyed by assistive technology.
...
- Clear labels identifying the date picker.
