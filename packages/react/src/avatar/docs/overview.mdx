...
<ResponsivePreview
	href="/example-site/category/subcategory/multi-page-form"
	label="Preview viewing a record in a table"
	title="Responsive record table preview"
/>

Avatars are used to show a thumbnail representation of an individual.

```jsx live responsivePreviewHeading={title}
