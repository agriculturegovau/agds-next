...
Our design system provides a progress indicator for larger tasks that can be completed in any order and returned to at a later date, like doing a tax return or applying for a driver's licence.
