...
<Table>
	...
	<TableBody>
		<TableRow>
			...
			<TableCell>The step is available for the user to start.</TableCell>
		</TableRow>
		<TableRow>
			<TableCell>
				<code>started</code>
			...
			<TableCell>
				The user has reached this step and begun working on it, but it still
		...
		<TableRow>
			...
			<TableCell>
				The user has submitted valid data and it has been approved or verified
				(where necessary). This step is complete.
			</TableCell>
		</TableRow>
		<TableRow>
			<TableCell>
		...
		<TableRow>
			...
			<TableCell>
				The user has submitted valid data; however, the data can still be
				changed by the user or affected by conditional logic.
			</TableCell>
		</TableRow>
		<TableRow>
			<TableCell>
			...
			<TableCell>
				There is an error on this step that requires attention.
			</TableCell>
		</TableRow>
	</TableBody>
</Table>
