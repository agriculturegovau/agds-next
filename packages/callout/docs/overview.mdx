...
group: Content
storybookPath: /story/content-callout--on-light
---
...
The background of the Callout must pair with the background it is being placed on. If Callout is placed on a page with 'bodyAlt' background, please set `background="shadeAlt"`.
