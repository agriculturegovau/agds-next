...
The background of the ProgressIndicator must match the background it is being placed on. If ProgressIndicator is placed on 'bodyAlt' background, please set `background="bodyAlt"`.
