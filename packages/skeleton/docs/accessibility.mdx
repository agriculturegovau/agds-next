...
By using the [VisuallyHidden](/packages/foundations/a11y#visuallyhidden) component, we can indicate to screen readers that an element is in a loading state.
