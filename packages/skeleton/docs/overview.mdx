...
The `SkeletonHeading` component can be used as a placeholder for any [Heading component](/packages/heading).
...
The `SkeletonHeading` component can be used as a placeholder for any [Text component](/packages/text).
