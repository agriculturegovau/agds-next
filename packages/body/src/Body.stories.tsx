...
export const Full: ComponentStory<typeof Body> = (args) => {
	return (
		<Body {...args}>
			...
			<p>
				...
				meaning—if you code this way your indentation schema may as well be a
				form of{' '}
			...
			<p>
				...
				<ins>ins (insert)</ins> element, unlike the dog cannot jump over
				anything, so it cannot span cross paragraph boundaries.
			</p>
			...
			<main id="content">
				<dl>
					...
					<dd>
						...
						<small>
							Did you know?—a single definition term can have multiple
					...
					<dd>
						...
						<small>
							breakfast included,{' '}
							<abbr title="Goods and Services Tax">GST</abbr> inclusive
						</small>
					</dd>
					<dt>Double room</dt>
					<dd>
				...
				<p>
					Now to the <code>mark</code> element. This has a few useful
					applications:
				</p>

				<ul>
					<li>
						useful for marking up interesting things in quotations (without
						altering the styling of text, eg to italic)
					</li>
					<li>
