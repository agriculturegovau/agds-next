...
group: Foundations
storybookPath: /story/components-icon--all-icons
---
...
See the full list of available icons [here](https://steelthreads.github.io/agds-next/storybook/index.html?path=/story/components-icon--all-icons).
