...
Our component library uses the CSS-in-JS styling libraries Emotion and [Facepaint](https://emotion.sh/docs/media-queries#facepaint) which need to be installed as dependencies in your application. This can be done by running the following command in your terminal:
