...
To help users ‘get started’, use the first page of the [multi-page form template](https://design-system.agriculture.gov.au/templates/multi-page-form) in the AgDS. That is, prepare to complete a multi-page form in the Export Service.
...
To create pages that ask users a series of questions to provide them with tailored guidance, use the [multi-page form template](https://design-system.agriculture.gov.au/templates/multi-page-form) in AgDS.
...
Use conjunctions, prepositions and pronouns in between. For example, ‘create an account.’ Avoid starting with ‘how to’ if the statement makes sense without it.

A H1 can also be a question. But try to use questions as headings minimally or instead of a statement.

Start with one of the 5 ‘W’s’: ‘who’, ‘what’, ‘where’, ‘when’ or ‘why’ for question headings.

- **include a short introduction that describes the page content**. It should be no longer than 2 sentences (or 30 words).

- **be concise**. Use subheadings to break up content into short sections. If you need more than 2 subheadings, consider dividing the content over more help pages.

Use short sentences so it’s easier for users to skim-read. Communicate one unique task or idea per page.
...
- **use screenshots or videos**. They can become outdated. That’s unless you plan to update them whenever you iterate your product.

Also test with users if you can, to understand if they find them helpful within your guidance.
...
#### Minimise ‘legalese’ where possible.

Legal content is often difficult for users to understand. That’s often due to the need for it to be accurate relevant to legislation and its intent for users.

But it still needs to be in plain English to be accessible to all users. You may be able to work with the relevant legal team to amend legal terms in some instances.

#### Keep content concise.

Big chunks of legal guidance make complex information even harder to consume. Break long paragraphs into several short ones so users can read it more easily.

#### Use first- and second-person point of view where appropriate.

For example, update 'Commonwealth' references in content provided by legal professionals, to ‘we’.

For example, ‘We make the Export Service guidance tool available for the benefit of the public.’

Check any updates you propose with the relevant legal team providing the legal content.

#### Maintain legal content.

You and your team are responsible for the ongoing management of legal content, and its removal (if it’s no longer needed).

If a new feature is released in the Export Service, update the relevant legal content to cover the new functionality if you need to. For example, a privacy notice or disclaimer.

#### Consider where to publish legal content online

Your legal content may be most appropriate within a task or informational page within the Export Service.

However, it may also be possible to place legal disclaimers on the DAFF [Disclaimer](https://www.agriculture.gov.au/about/disclaimer) or [Privacy](https://www.agriculture.gov.au/about/commitment/privacy) web pages. Seek the Principal Director’s approval to add such content.
