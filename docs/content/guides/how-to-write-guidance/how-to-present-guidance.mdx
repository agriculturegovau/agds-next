...
To create pages that ask users a series of questions to provide them with tailored guidance, use the [Multi-page form](https://design-system.agriculture.gov.au/templates/multi-page-form) template.

You can use the [Card](https://design-system.agriculture.gov.au/components/card) component to provide tailored guidance in a list format.
...
Where guidance might be relevant to some users, but might not be useful to all, use the [Details](https://design-system.agriculture.gov.au/components/details) component.
...
To present technical guidance, use the [Content page](https://design-system.agriculture.gov.au/templates/content) template in AgDS.
...
<DontHeading />- **use ‘legalese’**. Legal content is often difficult for users
...
```jsx live
<Prose>
	<h2>Declarations and concent</h2>
