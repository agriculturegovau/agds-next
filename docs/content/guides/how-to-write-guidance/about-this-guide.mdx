...
Who should use this guide and who are our Export Service users.
...
- [Export Service](https://agriculture-exports.awe.gov.au/account/help/) delivery teams, like content designers and interaction designers
...
Please note, this guide and the [AgDS Content section](/conten) is not for use for DAFF staff engaged in regulatory work for agricultural exports.
...
You can find regulatory guidance in the Export Regulatory Knowledge Hub (internal DAFF staff only). Access the hub on DAFF’s SharePoint intranet site, The source.
