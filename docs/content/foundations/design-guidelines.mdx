...
When hovering an interactive element, you should communicate the change by inverting the underline, adding a shade background, and/or changing the colour of the text to `body`.

A coloured border below or aside an element can be used to communicate a selected state.
