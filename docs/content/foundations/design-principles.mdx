...
If something is purely decorative, adds cognitive load, adds unnecessary bloat, or may create challenges for some users - rethink it to make the experience simple and intuitive for all.
