...
We recommend WCAG conformant timing to ensure your digital products and services are stress free and accessible for a wide audience. We don’t support time-based alerts like ‘Toasts’ and prefer persistent patterns like [section alerts](/components/section-alert) to inform users about changes.
