...
Our use of text size and spacing in our components achieved full WCAG conformance in accessibility audits in 2022 and 2024. Implementation of AgDS text size and spacing in our patterns is demonstrated in the yourGov application.
