...
From [Using ARIA – First rule of ARIA](https://www.w3.org/TR/using-aria/#rule1)
...
- Follow [WAI-ARIA Authoring Practices](https://www.w3.org/WAI/ARIA/apg/) for any custom widgets.
