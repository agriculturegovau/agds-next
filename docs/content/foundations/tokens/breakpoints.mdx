...
When designing a webpage or composition, always consider how it should look on mobile devices.

Use Autolayout to compose screens - including auto-wrapping and max-widths - to ensure your designs reflow expectedly.

Compose the same layout in multiple frames, to experiment and document how the layout should change for different device widths. You may consider using the following frame widths:
...
Note that we support devices with a minimum width of 320px.
