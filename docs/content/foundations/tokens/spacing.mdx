...
<SummaryList>
	...
	<SummaryListItem>
		...
		<SummaryListItemDescription>
			<ul>
				<li>
					Spacing between icons and text in primary navigation list components,
					like [App layout](/components/app-layout) and [Dropdown
	...
	<SummaryListItem>
		...
		<SummaryListItemDescription>
			<ul>
				...
				<li>Used for the horizontal and vertical gaps between cards in Card grids.</li>
				<li>Used for the padding inside medium sized components, like [Callout](/components/callout), [Card](/components/card) and [Page
					alert](/components/page-alert).</li>
				<li>Used as a top margin for paragraphs in [Prose](/components/prose) body text.</li>
				<li>Used in [Form stack](/components/form-stack) as the gap between form fields in [search filters](/patterns/search-filters).</li>
			</ul>
		</SummaryListItemDescription>
	</SummaryListItem>
	<SummaryListItem>
