...
See Paragraphs and lists in [Content structure](/guides/content-structure) for more information. Also see Lists in the DAFF Style guide (DAFF staff only).
...
<Prose>
	...
	<p>
		To link more than 5 businesses, complete the Assistance to link bulk ABNs
		form.
	</p>
</Prose>
```
