...
description: How to organise, separate and format content on a page.
order: 2
---

## Use the right page template

Start creating content in the Export Service by using the right page template. To select the type of page and source the code, see [Templates](/templates).

For example, you can create a landing or static web page using a [Content page template](/templates/content).
...
It’s common for screen reader users to understand a page’s context and hierarchy through its heading structure, and to navigate content by jumping from one heading to the next. You can nest heading levels to create subsections of content, but you cannot not skip heading levels as this will confuse some users.
