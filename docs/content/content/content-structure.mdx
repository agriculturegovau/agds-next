...
It's common for screen reader users to navigate content by jumping from one heading to the next. You can nest heading levels to create subsections of content, but you should not skip heading levels as this will confuse some users.
