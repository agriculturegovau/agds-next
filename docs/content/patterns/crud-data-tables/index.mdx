...
Provide a side drawer or side page to provide the record information. Use side drawer for small records or side pages for longer records that a user will need to scroll.
...
## Upload a undefined list of files to a table
...
The upload undefined list of files pattern reduces the amount of form content on the parent page page making it easier for users to complete the form, and keeps the users context and focus when providing all required metadata in the side drawer or subpage.
...
The upload defined list of pattern reduces the amount of form content on the parent page making it easier for users to complete the form, and keeps the users context and focus when providing all required metadata in the side drawer or subpage.
...
The uploaded file should also be visible in a table or list on the parent page. Provided an edit or remove action in the table row or list to enable files to be changed.
