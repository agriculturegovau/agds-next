...
<Details label="Why should I invite a new staff member?" iconBefore>
	<Text as="p">
		Inviting individuals to the service can help you streamline your operations.
		You can then assign them a role, so they can access necessary information
		and tasks.
	</Text>
	<Text as="p">
...
- [Hint](/components/field#hint) - Short, in context help.

- [Links](/content/content-styles#links) - Also known as hyperlinks, connects users to helpful, related content.
