...
- **Non-sequential** - If a form can be completed in any order, use the non-sequential variant of task list seen below. This gives users the flexibility of completing tasks at they please. If they’re not ready or able to complete a certain task, they can move onto another one without getting blocked.
...
<Box paddingTop={3}>
	{/* Image needs to be updated with a better version
	<img
		src="/img/patterns/return-to-partial-completion-task.png"
		alt="Return to partial completion task"
	/>
	*/}
	<img
		src="/pr-preview/pr-1585/img/patterns/return-to-partial-completion-task.png"
		alt="Return to partial completion task"
	/>
</Box>
