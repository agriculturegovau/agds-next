...
yourGov includes a complex data table that displays staff records. The table supports advanced interactions such as sorting, [filtering](), individual and batch actions. Users are able to see, compare, and manage a dataset.
