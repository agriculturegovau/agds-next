...
Use a [Control group](/components/control-group) with a list of [Checkboxes](/components/checkboxes) or [Radio buttons](/components/radio) when there are 8 or fewer options.
