...
1 to 2 of the most used filters should be displayed as the primary filters outside the [Filter drawer](/components/filter-drawer) to make them easier and faster to access.
