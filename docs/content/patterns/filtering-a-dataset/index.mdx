...
When filtering a list of [Cards](/components/card) in a search results page, we use a two-column layout with the [Filter sidebar](/components/filter-sidebar) component containing the filters. The cards are displayed in the main content area.
