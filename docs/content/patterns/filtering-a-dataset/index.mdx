...
- remove tags as they allow users to see the selections that are active and remove them easily
...
Medium is intended to display 3-6 filters in an accordion that is triggered by a button.

1 to 2 of the most used filters should be displayed outside the accordion to make them easier and faster to access.
