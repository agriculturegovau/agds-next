...
When filtering a list of cards, we use a two-column layout with the [Filter sidebar](/components/filter-sidebar) component containing the filters. The cards are displayed in the main content area.
