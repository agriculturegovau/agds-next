...
relatedComponents: ['drawer', 'pagination']
---
...
## Filtering lists of cards

This pattern is used to display a collection of filterable links ([Cards](/components/card)) in a search results page.
...
[View Storybook preview](https://design-system.agriculture.gov.au/storybook/index.html?path=/story/patterns-data-filtering-and-sorting--list)
