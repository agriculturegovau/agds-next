...
4. **Cancel button:** When pressed, the drawer should close. Any changes that have been made since opening the drawer should be discarded. This is essentially the same as the ‘Close’ button.nges that have been made since opening the Drawer should be discarded. This is essentially the same as the "Close" button.
...
[View Storybook preview](/storybook/index.html?path=/story/patterns-search-results--list)
