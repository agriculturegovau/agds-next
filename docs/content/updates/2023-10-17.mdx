...
description: Extended Pagination to support items range text and items per page select dropdown, improved accessibility of the Dropdown menu, plus various bug fixes and improvements.
---
