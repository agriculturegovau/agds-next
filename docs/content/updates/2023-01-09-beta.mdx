...
Accessibility is a huge focus area for AgDS. An independent third-party specialist recently reviewed AgDS against the Web Content Accessibility Guidelines (WCAG). This review also included usability testing sessions with users who heavily rely on assistive technologies. We are proud to have achieved AA-level compliance against the WCAG v2.1 standard by this agency, who now refer to AgDS as an exemplary implementation of an accessible React based design system.
