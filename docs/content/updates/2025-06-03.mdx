...
description: Fixes various hydration issues and improves consumption when using Next.js’ App Router, improves clickable table rows, adds a new YouTube icon, plus various bug fixes and improvements.
---
