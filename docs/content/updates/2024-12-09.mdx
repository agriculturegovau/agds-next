...
description: Improves the accessibility and documentation for many components, improves the performance of Box and Combobox, initial release of yourgov app, plus various other bug fixes and improvements.
---
...
- Prevent focus ring from being cut off by screen edge and sibling links.
...
- Fix iOS VoiceOver’s announcement of options.
...
- docs: Update badge examples to have announced text reflect visual text.
...
- Initial release of example application.
