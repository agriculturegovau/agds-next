...
description: Visual refresh of the Global alert component, updated App layout for easier integration via ag-common, plus various bug fixes and improvements.
---
