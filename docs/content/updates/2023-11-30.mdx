...
Aside from the complete release notes on the @ag.ds-next website, you can also view the verbose change log in the [related PR](https://github.com/agriculture/agds-next/pull/1492) for this release.
