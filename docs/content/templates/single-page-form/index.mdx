...
Try to avoid disabled buttons as they can be problematic for accessibility users. They don’t provide feedback why they’re not clickable casuing people to get stuck. They are also hard to see for those with poor eyesight, and aren’t natively keyboard accessible.
