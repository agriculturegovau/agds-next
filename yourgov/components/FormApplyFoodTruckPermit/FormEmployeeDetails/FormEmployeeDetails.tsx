...
import {
	FormEmployeeDetailsStep0,
	formSchema as formEmployeeDetailsStep0Schema,
	FormSchema as FormEmployeeDetailsStep0Schema,
} from './FormEmployeeDetailsStep0';
import {
	FormEmployeeDetailsStep1,
	formSchema as formEmployeeDetailsStep1Schema,
	FormSchema as FormEmployeeDetailsStep1Schema,
} from './FormEmployeeDetailsStep1';
import {
	FormEmployeeDetailsStep2,
	formSchema as formEmployeeDetailsStep2Schema,
	FormSchema as FormEmployeeDetailsStep2Schema,
} from './FormEmployeeDetailsStep2';
import { FormEmployeeDetailsStep6 } from './FormEmployeeDetailsStep3';

export const FORM_STEPS = [
	{
		label: 'Employees',
		component: FormEmployeeDetailsStep0,
	},
	{
		label: 'Employee roles',
		component: FormEmployeeDetailsStep1,
	},
	{
		label: 'Food safety supervisor',
		component: FormEmployeeDetailsStep2,
	},
	{
		label: 'Confirm and submit',
		component: FormEmployeeDetailsStep6,
	},
];
...
export type FormState = Partial<{
	[0]: FormEmployeeDetailsStep0Schema & { completed: boolean };
	[1]: FormEmployeeDetailsStep1Schema & { completed: boolean };
	[2]: FormEmployeeDetailsStep2Schema & { completed: boolean };
}>;

export const formSchema = yup.object({
	[0]: formEmployeeDetailsStep0Schema,
	[1]: formEmployeeDetailsStep1Schema,
	[2]: formEmployeeDetailsStep2Schema,
});

export const FormEmployeeDetails = () => {
	const [isSideFlow, setIsSideFlow] = useState(false);

	const { homePageUrl, startTask, submitTask1, task2FormState } =
...
export const useFormEmployeeDetails = () => {
