...
export type FormState = Partial<{
	[0]: FormRegisterPetPersonalDetailsStep0Schema & Completion;
	[1]: FormRegisterPetPersonalDetailsStep1Schema & Completion;
	[2]: FormRegisterPetPersonalDetailsStep2Schema & Completion;
}>;
