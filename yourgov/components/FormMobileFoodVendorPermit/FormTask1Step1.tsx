...
export function FormTask1Step1() {
	const { isSideFlow, setIsSideFlow } = useFormMobileFoodVendorPermit();
							...
							<Stack gap={1.5} alignItems="flex-start" width="100%">
								...
								<Details label="How were my details prefilled?" iconBefore>
									<Prose>
										...
										<p>
											If we already have some of the information you need to
											tell us, we’ll pre-fill it into your applications. This
											saves you entering all your details yourself.
										</p>
										<p>
