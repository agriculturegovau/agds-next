		...
		<>
			...
			<SiteLayout>
				<HeroBanner
					...
					image={
						<img
							src="/yourgov/placeholder/hero-banner.png"
							role="presentation"
							alt=""
						/>
					}
	...
	return (
		...
		>
			<path
				...
				fill="currentColor"
			/>
			<circle cx="32" cy="26" r="11" stroke="currentColor" stroke-width="2" />
			<path
	...
	return (
		...
		>
			...
			<rect
				...
				stroke-width="2"
			/>
			<circle cx="49" cy="48" r="11" stroke="currentColor" stroke-width="2" />
			<path
	...
	return (
		...
		>
			...
			<path
				...
				stroke-linejoin="round"
			/>
			<circle cx="47" cy="49" r="6" stroke="currentColor" stroke-width="2" />
			<circle
				cx="2"
				cy="2"
				r="2"
