						...
						<Stack gap={3}>
							<Breadcrumbs
								links={[
									...
									{
										label: 'Operate a food truck, van or stall on public areas',
									},
								]}
							/>
							<Stack gap={1.5}>
								...
								<Text as="p" fontSize="md" color="muted">
									If you are preparing and or handling food for retail sale from
									a vehicle or stall, you must have approval to operate on
									public areas.
								</Text>
							</Stack>
							<InpageNav
								...
								<Accordion>
									<AccordionItem title="Food van permit">
										<AccordionItemContent>
											<Prose>
												<p>
													This is a standard paragraph - sm/default (P). This is
													a standard paragraph - sm/default (P). This is a
...
Page.getLayout = function getLayout(page: ReactElement) {
	return <SiteLayout applyMainElement={false}>{page}</SiteLayout>;
};
