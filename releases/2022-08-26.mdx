...
Take a look at [Storybook](https://steelthreads.github.io/agds-next/storybook/index.html?path=/story/components-mainnav--header-right-links) and the [Storybook code](https://github.com/steelthreads/agds-next/blob/main/packages/main-nav/src/MainNav.stories.tsx) for more references.
